...
<h1>Mobigo</h1>
<span class="brk"></span>
<p>Mobigo is the best online portal to buy your favourate stuff like mobiles and smartphones.
They say you never get a second chance to make a first impression.</p> 
...
<h2>Who We Are?</h2>
<span class="brk"></span>
<p>Mobigo Indias Ultimate Online Shopping Destination Mobigos vision is to create Indias most reliable and frictionless commerce ecosystem that creates life-changing experiences for buyers and sellers. In jan 2017, Aashwin Trivedi started Mobigo.com - India’s largest online marketplace for Mobiles and smartphones, with the widest range of products and diverse categories from over regional, national, and international brands and retailers. With so many of users.
</div>
</div>
...
<div class="row">
    ...
    <div class="thumbnail">
       ...
       <img class="team-pic" src="resources/aboutusphoto.jpg">
      <div class="caption">
        <h3>Trivedi Aashwin</h3>
        <p class="card-description">Trivedi Aashwin is an Indian software engineer and Internet entrepreneur. In 2017 he founded the e-commerce platform Mobigo.In January 2017 he is Group CEO[1] of Mobigo.</p>
        <p class="social"><a href="https://www.facebook.com"><i class="fa fa-facebook"></i></a> <a href="https://www.twitter.com"><i class="fa fa-twitter"></i></a> <a href="https://www.linkedin.com"><i class="fa fa-linkedin"></i></a> <a href="https://www.googleplus.com"><i class="fa fa-google-plus"></i></a></p>
      </div>
    </div>
  </div>
